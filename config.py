...
class Config(object):
    ...
    CLIENT_SECRET = "8~G8Q~sClSppAJWe4zMfjXaN1UTIjgLSdsxEfbdD"
    ...
    AUTHORITY = "https://login.microsoftonline.com/35f51d09-8a42-4b2f-b248-51c818668a55"  # For multi-tenant app, else put tenant name
