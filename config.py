...
class Config(object):
    ...
    BLOB_ACCOUNT = os.environ.get('BLOB_ACCOUNT') or 'trinhcvstorageaccount'
    BLOB_STORAGE_KEY = os.environ.get('BLOB_STORAGE_KEY') or '91fOj0HB2wm0VKCJDHYO0u3HbTnHXk947CsKISKY5zIs5S8ah5wpTC/MZEzq3o6eQMuJhSIcfyZE+AStK9sNEQ=='
    BLOB_CONTAINER = os.environ.get('BLOB_CONTAINER') or 'images'

    SQL_SERVER = os.environ.get('SQL_SERVER') or 'trinhcvcms.database.windows.net'
    SQL_DATABASE = os.environ.get('SQL_DATABASE') or 'cmstrinhcv'
    SQL_USER_NAME = os.environ.get('SQL_USER_NAME') or 'trinhcv'
